...
export const configuration = {
    schema: {
        ...
        widthSegments: new Attributes.Integer({ value: 1, min: 1 }),
        heightSegments: new Attributes.Integer({ value: 1, min: 1 }),
    },
}
